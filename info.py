...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7711232723').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002266160950').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002412532563'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002412532563'))  # Bin channel id (make sure bot is admin)
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002487310560')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002412532563').split()]
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002266160950').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002266160950').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://t.me/RM_Botz')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@VerifiedRebel')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://jnapjbbspjhshk:8gNrZ4cJddcpfdjl@cluster0.sdb7z.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/RM_Botz')  # How to open tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/RM_Botz')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/RM_Botz')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/RM_Botz')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/RM_Botz')
OWNERID = int(os.environ.get('OWNERID', '7711232723'))  # Replace with the actual admin ID
